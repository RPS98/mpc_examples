 ...
 * executable. Dispatches PID and MPC-Trajectory controllers plus all four
...
std::string defaultControllerConfigPath(const std::string& name) {
  ...
  if (name == ControllerKeys::kMpcTrajectory) return "configs/controllers/config_mpc_trajectory.yaml";
  throw std::invalid_argument(
      "factories_trajectory: unsupported controller '" + name +
