...
"""Unified Python example: MpcPositionController + JerkLimitedGenerator.

Python mirror of ``examples/examples/mpc_position_jerk_limited/run_example.cpp``. Consumes the
...
def main() -> int:
    args = parse_full_args(
        prog='mpc_position_jerk_limited',
        ...
        default_output_file='simulator_logs/mpc_position_jerk_limited_log.csv',
    )
