...
"""Unified Python example: PidGeometricController + JerkLimitedGenerator.

Python mirror of ``examples/examples/pid_jerk_limited/run_example.cpp``. Consumes the
...
def main() -> int:
    args = parse_full_args(
        ...
        default_output_file='simulator_logs/pid_jerk_limited_log.csv',
    )
