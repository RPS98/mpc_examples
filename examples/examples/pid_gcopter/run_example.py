...
"""Unified Python example: PidGeometricController + GcopterGenerator.

Python mirror of ``examples/examples/pid_gcopter/run_example.cpp``. Consumes the
...
def main() -> int:
    args = parse_full_args(
        ...
        default_output_file='simulator_logs/pid_gcopter_log.csv',
    )
