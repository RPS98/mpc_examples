...
"""Unified Python example: MpcTrajectoryController + DynamicTrajectoryGenerator.

Python mirror of ``examples/examples/mpc_trajectory_dynamic/run_example.cpp``. Consumes the
...
def main() -> int:
    args = parse_full_args(
        ...
        default_output_file='simulator_logs/mpc_trajectory_dynamic_log.csv',
    )
