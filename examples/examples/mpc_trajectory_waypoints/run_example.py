...
"""Unified Python example: MpcTrajectoryController + WaypointReferenceGenerator.

Python mirror of ``examples/examples/mpc_trajectory_waypoints/run_example.cpp``. Consumes the
...
def main() -> int:
    args = parse_full_args(
        ...
        default_output_file='simulator_logs/mpc_trajectory_waypoints_log.csv',
    )
