...
"""Unified Python example: MpcPositionController + DynamicTrajectoryGenerator.

Python mirror of ``examples/examples/mpc_position_dynamic/run_example.cpp``. Consumes the
