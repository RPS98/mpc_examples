...
"""Unified Python example: MpcPositionController + GcopterGenerator.

Python mirror of ``examples/examples/mpc_position_gcopter/run_example.cpp``. Consumes the
