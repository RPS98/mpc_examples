 ...
 * @brief Unified example: MpcPositionController + WaypointReferenceGenerator.
 *
...
struct Args {
  ...
  std::string trajectory_config_path = "configs/generators/config_waypoints.yaml";
  std::string output_file            = "simulator_logs/mpc_position_waypoints_log.csv";
};
...
int main(int argc, char** argv) {
  ...
  const auto traj_cfg =
      adapters::WaypointReferenceGenerator::loadConfigFromYaml(args.trajectory_config_path);
